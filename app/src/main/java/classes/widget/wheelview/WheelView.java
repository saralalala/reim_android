...
package classes.widget.wheelview;
...
import classes.widget.wheelview.adapter.WheelViewAdapter;
...
public class WheelView extends View
{
    ...
    // Wheel drawables
    private int wheelBackground = R.drawable.wheel_background;
    private int wheelForeground = R.drawable.wheel_value;
