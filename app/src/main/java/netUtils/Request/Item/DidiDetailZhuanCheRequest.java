...
public class DidiDetailZhuanCheRequest extends BaseRequest
{
    public DidiDetailZhuanCheRequest(String orderID, String token)
    {
        super();
        ...
        setUrl(URLDef.URL_DIDI_ZHUAN_CHE_DETAIL);
    }
